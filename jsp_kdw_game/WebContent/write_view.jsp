      ...
      <div class="container">
        <div class="row">
          <div class="card col-md-6 offset-md-3 offset-md-3">
            <h3 class="text-center mt-5">글 쓰 기</h3>
            <div class="card-body">
              ...
              <form action="${pageContext.request.contextPath}/board/write.do" method="POST">
	              <div class="form-group mb-3">
	                <label> 이름 </label>
	                <input type="text" placeholder="bname" name="bname" class="form-control"}" />
	              </div>
	              <div class="form-group mb-3">
	                <label> 제목 </label>
	                <input placeholder="btitle" name="btitle" class="form-control"}" />
	              </div>
	              <div class="form-group">
	                <label> 내용 </label>
	                <textarea placeholder="bcontent" name="bcontent" class="form-control" rows="5"></textarea>
	              </div>
