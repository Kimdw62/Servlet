          ...
          <div class="card col-md-6 offset-md-3 offset-md-3">
            ...
            <div class="card-body">
              ...
              <form action="${pageContext.request.contextPath}/board/modify.do" method="POST">
	              ...
	              <div class="form-group mb-3">
	                <label> 히트(조회수) </label>
	                <input type="text" placeholder="bid" name="bid" class="form-control" value="${board.bhit}" readonly />
	              </div>
	              <div class="form-group mb-3">
	                <label> 이름 </label>
	              ...
	              <div class="mt-3 d-flex justify-content-between">
	                ...
	                <button class="btn btn-primary"><a class="nav-link active" href="${pageContext.request.contextPath}/board/reply_view.do?bid=${board.bid}">답변</a></button>
